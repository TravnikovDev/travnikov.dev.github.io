...
const CodeSnippet = ({ style }) => (
  ...
  >
    <Text>
      <Box component="span" sx={{ color: '#E0000E' }}>function</Box> <Box component="span" sx={{ color: '#0077FF' }}>createImpressiveUI</Box>() {'{'}
      <br />
      &nbsp;&nbsp;<Box component="span" sx={{ color: '#2050FF' }}>const</Box> experience = <Box component="span" sx={{ color: '#0077FF' }}>amazing</Box>();
      <br />
      &nbsp;&nbsp;<Box component="span" sx={{ color: '#FFAC00' }}>// Add some parallax effects</Box>
      <br />
      &nbsp;&nbsp;<Box component="span" sx={{ color: '#E0000E' }}>return</Box> <Box component="span" sx={{ color: '#0077FF' }}>experience</Box>;
      <br />
      {'}'}
    </Text>
  </Box>
...
export default function HeroSection() {
  ...
  return (
    <Box
      ...
      sx={{
        ...
        '&::before': {
          ...
          right: 0,
          bottom: 0,
          background: 'radial-gradient(circle at top right, rgba(255, 255, 255, 0.5), rgba(255, 255, 255, 0.3) 70%), radial-gradient(circle at bottom left, rgba(255, 255, 255, 0.5), rgba(255, 255, 255, 0.3) 70%)',
          zIndex: -1,
          pointerEvents: 'none',
    ...
    >
      ...
      >
        <Box
          sx={{
            ...
            height: '80px',
            borderRadius: '50%',
            background: 'radial-gradient(circle at 30% 30%, rgba(0, 120, 240, 0.4), transparent 70%)',
            filter: 'blur(10px)',
      ...
      <Container size="xl" py={{ base: 'xl', sm: '2xl' }} mt={{ base: 50, sm: 80 }}>
        ...
        >
          <Text
            sx={{
              ...
              background: 'linear-gradient(to bottom, rgba(0, 77, 255, 0.035) 0%, rgba(0, 77, 255, 0.01) 100%)',
              WebkitBackgroundClip: 'text',
              // Text shadow for depth - lighter for light theme
              textShadow: '0 0 50px rgba(0, 119, 255, 0.03), 0 0 100px rgba(32, 80, 255, 0.02)',
        ...
        <Grid gutter={{ base: 40, sm: 80 }} align="center">
          ...
          <Grid.Col span={{ base: 12, md: 6 }} order={{ base: 2, md: 1 }}>
            ...
            >
              <Stack spacing={{ base: 'xl', sm: '2xl' }} h="100%" justify="center">
                <motion.div 
                  variants={itemVariants}
                  style={{ y: badgeY }} // Add parallax movement
                >
                  <Box mb="lg" className="shimmer"> {/* Add shimmer effect */}
                    <Badge 
                      size="xl" 
                ...
                <motion.div variants={itemVariants}>
                  <Title
                    ...
                    sx={{
                      ...
                      fontFamily: '"Monument Extended", "Clash Display", sans-serif', // Super dramatic font
                      ...
                      '&::before': {
                        ...
                        position: 'absolute',
                        inset: -8,
                        background: 'linear-gradient(135deg, rgba(0, 119, 255, 0.03), transparent 60%, rgba(32, 80, 255, 0.03))',
                        borderRadius: '8px',
                        filter: 'blur(10px)',
                        opacity: 0.5,
                        zIndex: -1,
                ...
                >
                  ...
                  >
                    I craft <Box component="span" className="highlight-blue" fw={900} sx={{ 
                      color: '#0077FF',
                      position: 'relative',
                      padding: '0 5px',
                      transformStyle: 'preserve-3d',
                    ...
                    <Box component="span" className="highlight-royal" fw={900} sx={{ 
                      color: '#2050FF',
                      position: 'relative',
                      padding: '0 5px',
                      transformStyle: 'preserve-3d',
                      display: 'inline-block',
                      transform: 'translateZ(5px) skewX(-5deg)', // Skew for dynamic effect
                    }}> high-performance</Box> user interfaces 
                    with 10+ years of experience. My expertise spans across <Box component="span" fw={700} sx={{ 
                      color: '#0077FF',
                      textDecoration: 'underline',
                      textDecorationColor: 'rgba(0, 119, 255, 0.3)',
                      textDecorationThickness: '2px',
                      textUnderlineOffset: '3px',
                    }}>React</Box>, <Box component="span" fw={700} sx={{ 
                      color: '#2050FF',
                      textDecoration: 'underline',
                      textDecorationColor: 'rgba(32, 80, 255, 0.3)',
                      textDecorationThickness: '2px',
                      textUnderlineOffset: '3px',
                    }}>TypeScript</Box>, and modern frontend technologies to create exceptional user experiences.
                  </Text>
                </motion.div>
                
                <motion.div variants={itemVariants}>
                  <Group gap="xl" mt={{ base: 30, sm: 40 }}> {/* Increased top margin */}
                    <motion.div
                    ...
                    >
                      <Button 
                        ...
                        sx={{
                          ...
                          backdropFilter: 'blur(10px)',
                          boxShadow: '0 10px 30px rgba(0, 0, 0, 0.2), 0 0 20px rgba(0, 120, 240, 0.3)', // Stronger shadow & glow
                    ...
                    >
                      <Button 
                        ...
                        sx={{
                          ...
                          boxShadow: '0 10px 30px rgba(0, 0, 0, 0.15), 0 0 15px rgba(112, 0, 224, 0.2)', // Enhanced shadow & glow
                          transform: 'translateZ(20px)', // 3D effect with parallax
                          position: 'relative',
                          overflow: 'hidden',
                          ...
                          '&:hover': {
                            ...
                            boxShadow: '0 15px 40px rgba(0, 0, 0, 0.2), 0 0 25px rgba(112, 0, 224, 0.3)',
                          },
                          '&:active': {
                            transform: 'translateZ(20px) translateY(3px)',
                            boxShadow: '0 5px 15px rgba(0, 0, 0, 0.1), 0 0 10px rgba(112, 0, 224, 0.2)',
                          }
                        }}
                      >
                        Get in Touch
                ...
                >
                  <Group gap="md">
                    {['React', 'TypeScript', 'Three.js', 'Node.js'].map((tech, i) => (
                      <Badge
                        key={tech}
                        size="md"
                        radius="md"
      ...
      >
        <Container size="xl">
          <Box className="animated-border" sx={{ 
            padding: '3rem',
            ...
            <Title order={2} mb="xl" className="shimmer" sx={{ 
              color: '#003A84', 
            ...
            <Grid gutter={40}>
              {[
                { title: "Projects", icon: "💻", color: "#0077FF", path: "/projects" },
                { title: "Blog", icon: "📝", color: "#2050FF", path: "/blog" },
                { title: "Experiments", icon: "🧪", color: "#FFAC00", path: "/experiments" }
              ].map((item, i) => (
                  ...
                  >
                    <Link to={item.path} style={{ textDecoration: 'none' }}>
                      <Box sx={{ 
                        ...
                        <Text size="3xl" mb="md">{item.icon}</Text>
                        <Title order={3} sx={{ color: item.color, marginBottom: '1rem' }}>
                          {item.title}
                        </Title>
                        <Text size="md" sx={{ color: '#39485E' }}>
                          Discover amazing {item.title.toLowerCase()} with smooth scroll animations and interactive elements.
                        </Text>
                      </Box>
                    </Link>
                  </motion.div>
