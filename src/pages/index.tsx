    ...
    <>
      ...
      <motion.div 
        style={{ 
          ...
          height: '40vw',
          borderRadius: '50%',
          background: 'radial-gradient(circle at center, rgba(34, 144, 224, 0.15) 0%, rgba(36, 43, 64, 0) 70%)',
          filter: 'blur(60px)',
          zIndex: -1,
          pointerEvents: 'none',
        }}
      ...
      <motion.div 
        style={{ 
          ...
          background: 'radial-gradient(circle at center, rgba(132, 34, 224, 0.12) 0%, rgba(36, 43, 64, 0) 70%)',
          filter: 'blur(50px)',
          zIndex: -1,
          pointerEvents: 'none',
      ...
      <motion.div 
        style={{ 
          ...
          background: 'radial-gradient(circle at center, rgba(240, 31, 36, 0.08) 0%, rgba(36, 43, 64, 0) 70%)',
          filter: 'blur(60px)',
          zIndex: -1,
          pointerEvents: 'none',
        }}
      ...
      <motion.div
        style={{
          ...
          right: 0,
          height: '2px',
          background: 'linear-gradient(90deg, transparent, var(--mantine-color-primary-6), var(--mantine-color-secondary-6), transparent)',
      ...
      <motion.div
        style={{
          ...
          right: 0,
          height: '1px',
          background: 'linear-gradient(90deg, transparent, var(--mantine-color-secondary-6), var(--mantine-color-primary-6), transparent)',
          backgroundSize: '400% 400%',
