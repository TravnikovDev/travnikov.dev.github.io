...
import { SimpleGrid, Card, Image, Text, Badge, Group, Title, Container, Box, Code, Button } from '@mantine/core';
...
export default function ExperimentsPage({ data }: ExperimentsPageProps) {
  ...
  return (
    <BaseLayout>
      <Container size="lg" py="xl">
        <Box mb="xl">
          <Title order={1} mb="md">Web Experiments</Title>
          <Text size="lg">
            A collection of fun and interactive frontend experiments showcasing creative techniques and concepts.
          </Text>
        </Box>
        ...
        {experiments.length > 0 ? (
          ...
          >
            {experiments.map((experiment) => (
              <Card key={experiment.id} shadow="sm" padding="lg" radius="md" withBorder>
                {experiment.image && (
                  <Card.Section>
                    <Image
                ...
                <Title order={3} mt="md" mb="xs">{experiment.title}</Title>
                <Group mb="md">
                ...
                {experiment.codeSnippet && (
                  <Box mb="md">
                    <Text fw={500} mb="xs">Sample Code:</Text>
          ...
          >
            {[1, 2, 3, 4].map((i) => (
              <Card key={i} shadow="sm" padding="lg" radius="md" withBorder>
                ...
                <Title order={3} mt="md" mb="xs">Experiment {i}</Title>
                <Group mb="md">
                  <Badge color="blue" variant="light">React</Badge>
                  <Badge color="green" variant="light">Three.js</Badge>
                </Group>
                <Text mb="md">
                  This is a placeholder for an experiment description. Experiments will be loaded from Markdown files.
                </Text>
                <Box mb="md">
                  <Text fw={500} mb="xs">Sample Code:</Text>
  ...
  return <div>Hello World</div>;
                ...
                <Button fullWidth disabled>View Live Demo</Button>
              </Card>
            ))}
          </SimpleGrid>
        )}
