...
import { Card, Image, Text, Group, Title, Container, Box, Stack, Divider } from '@mantine/core';
    ...
    <BaseLayout>
      <Container size="lg" py="xl">
        <Box mb="xl">
          ...
          <Text size="lg">
            Thoughts, insights, and experiences from my journey as a frontend developer.
          </Text>
        </Box>
                  ...
                  <Card shadow="sm" padding="lg" radius="md" withBorder>
                    <Group align="flex-start" gap="xl">
                      ...
                      <Box>
                        ...
                        <Title order={3} mb="sm">{article.title}</Title>
            ...
            [1, 2, 3, 4].map((i) => (
              <Card key={i} shadow="sm" padding="lg" radius="md" withBorder>
                <Group align="flex-start" gap="xl">
                  ...
                  <Box>
                    <Text size="sm" c="dimmed" mb="xs">January 1, 2023</Text>
                    <Title order={3} mb="sm">Blog Post {i}</Title>
                    <Text>
                      This is a placeholder for a blog post excerpt. Blog posts will be loaded from Markdown files.
                    </Text>
                  </Box>
                </Group>
              </Card>
