...
export const serviceItem: string;
export const serviceName: string;
export const serviceBlurb: string;
export const serviceCta: string;
export const serviceFooter: string;
export const serviceFooterText: string;
export const serviceFooterCta: string;
